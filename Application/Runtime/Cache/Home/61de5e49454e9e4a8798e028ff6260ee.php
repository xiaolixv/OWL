...
<script src="/owl/Public/js/jquery.tmpl.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    function gotoScrum(id){
        window.location.href="/owl/index.php/Home/Front/Scrumlist?id="+id;
    }
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            dataType:'json',
            data:searchModel,
            url:"/owl/index.php/Home/Project/SearchProject",
    ...
    $("#submit").click(function(){
        ...
        $.ajax({
            type: 'POST',
            dataType:'json',
            url: "/owl/index.php/Home/Project/AddProject",
            data: model,
            success:function(data){
                alert(data);
                $("#myModal").modal("hide");
